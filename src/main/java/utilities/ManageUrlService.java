...
public class ManageUrlService {
    ...
    public static void signOutManual(WebDriver driver){
        ManageUrlService.getURL("",driver);
        HeaderPagePart headerPagePart = PageFactory.initElements(driver, HeaderPagePart.class);
        headerPagePart.clickSignOutLink();
        WaiterService.waitForCookieUnset("wac",driver);
        driver.navigate().back();
        Log.info("You sign out now.");
    }
